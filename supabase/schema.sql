...
-- Generated for PostgreSQL 14+ / Supabase
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS public.study_goals (
    id TEXT PRIMARY KEY,
    title TEXT NOT NULL,
    category TEXT NOT NULL DEFAULT 'hours',
...
VALUES
    ...
    ('sess-4', 'sub-3', 'asg-3', NOW() - INTERVAL '3 days', 60, 'deep_work', 'Finalized macroeconomic case study draft citations.', 5, 'focused')
ON CONFLICT (id) DO NOTHING;
